...
const BrushZoomSegmentChart = (props) => {
    ...
    <div>
      ...
      >
        <VictoryLine
          ...
          data={sampleData.map((k) => {
            return { x: k.startTime, y: k.segmentedProfileCounter };
          })}
        />
      </VictoryChart>
...
export default BrushZoomSegmentChart;
