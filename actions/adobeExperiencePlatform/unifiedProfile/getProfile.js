  ...
  return new Promise(function (resolve, reject) {
    try {
      var options = {
        ...
        url: `https://platform.adobe.io/data/core/ups/access/entities?entityId=${params.identityValue}&entityIdNS=${params.identityNamespace}&mergePolicyId=${params.mergePolicyId}&schema.name=_xdm.context.profile&withCA=true`,
      };
      console.log(options);
